...
import { LogOut, Bell, Moon, Shield, Info, ChevronRight, Camera, Check, X, Zap, Crown, MessageCircle } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-900 dark:to-gray-800 flex flex-col transition-colors">
      ...
      <div className="bg-gradient-to-r from-blue-500 to-indigo-500 p-4 text-white sticky top-0 z-30">
        <p className="font-black text-lg text-center">Настройки</p>
      </div>

      {/* Профиль */}
      <div className="p-6">
        <div className="bg-white dark:bg-gray-800 rounded-3xl border-2 border-blue-200 dark:border-gray-700 p-6 shadow-sm flex items-center gap-4 transition-colors">
            ...
            {editDesc ? (
              <div className="flex items-center gap-1 mt-1">
                <input
                  ...
                  maxLength={60}
                  className="flex-1 px-2 py-1 text-sm rounded-lg border-2 border-blue-300 focus:outline-none focus:border-blue-500 dark:bg-gray-700 dark:text-gray-100 dark:border-gray-600"
                  placeholder="О себе..."
                  autoFocus
                />
      ...
      <div className="px-4 pb-24 space-y-3">
        <div className="bg-white dark:bg-gray-800 rounded-2xl border-2 border-blue-100 dark:border-gray-700 overflow-hidden transition-colors">
          <div className="w-full flex items-center gap-3 p-4 border-b border-blue-50 dark:border-gray-700">
            ...
            <button
              ...
              className={`w-12 h-6 rounded-full transition-colors cursor-pointer ${notifications ? "bg-blue-500" : "bg-gray-300 dark:bg-gray-600"}`}
            >
          ...
          <div className="w-full flex items-center gap-3 p-4 border-b border-blue-50 dark:border-gray-700">
            ...
            <button
              onClick={toggle}
              className={`w-12 h-6 rounded-full transition-colors cursor-pointer ${darkMode ? "bg-blue-500" : "bg-gray-300 dark:bg-gray-600"}`}
            >
              <div className={`w-5 h-5 bg-white rounded-full shadow-sm transition-transform mt-0.5 ${darkMode ? "translate-x-6" : "translate-x-0.5"}`} />
            </button>
          </div>

          <button className="w-full flex items-center gap-3 p-4 hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors border-b border-blue-50 dark:border-gray-700">
          ...
          <button className="w-full flex items-center gap-3 p-4 hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors">
            ...
            <>
              ...
              <div className="border-b border-yellow-50 dark:border-yellow-900/20">
                <button
                  ...
                  className="w-full flex items-center gap-3 p-4 hover:bg-yellow-50 dark:hover:bg-yellow-900/10 transition-colors disabled:opacity-50"
                >
                  <div className="w-8 h-8 bg-red-100 dark:bg-red-900/30 rounded-lg flex items-center justify-center">
                    <Shield className="w-4 h-4 text-red-500" />
                  </div>
                  <div className="flex-1 text-left">
                    <span className="font-medium text-sm text-gray-800 dark:text-gray-200">Написать админу</span>
                    <p className="text-xs text-gray-400">Осталось: {adminContacts} из 2</p>
                  </div>
                </button>
              </div>
            </>
        ...
        >
          ...
          <span className="flex-1 text-left font-medium text-red-600 dark:text-red-400">Выйти из аккаунта</span>
        </button>

        <p className="text-center text-xs text-gray-400 pt-4">Wintozo v1.0 — Test</p>
      </div>
